...
public class Villageois : MonoBehaviour
{
    ...
    public StrategieChoixRessource strategieChoix;
    ...
    {
        string className = PlayerPrefs.GetString("StrategieChoix");

        switch (className)
        {
            case "StrategieChoixEquilibre":
                strategieChoix = new StrategieChoixEquilibre();
                break;
            case "StrategieChoixPlusProche":
                strategieChoix = new StrategieChoixPlusProche();
                break;
            case "StrategieChoixHasard":
